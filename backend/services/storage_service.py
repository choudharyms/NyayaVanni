...
def init_db(raise_on_error: bool = False):
    ...
    try:
        ...
        _ensure_document_templates_table(cursor)
...
def _ensure_document_templates_table(cursor):
    cursor.execute("""
    ...
    """)
    cursor.execute("""
        CREATE INDEX IF NOT EXISTS idx_document_templates_session_id
        ON document_templates(session_id)
    """)
